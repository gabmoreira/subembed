...
def parse_args():
    ...
    parser.add_argument("--dataset-path", type=str, required=True, help="Path to the Link Prediction dataset.")
    parser.add_argument("--closure", type=float, required=True, help="Fraction <= 1 of non-basic edges.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed.")
    parser.add_argument("--gamma-pos", type=float, default=0.8, help="Positive margin γ+.")
    parser.add_argument("--gamma-neg", type=float, default=0.1, help="Negative margin γ−.")
    parser.add_argument("--batch-size", type=int, default=128, help="Batch size for training.")
    parser.add_argument("--epochs", type=int, default=500, help="Number of training epochs.")
    parser.add_argument("--group-size", type=int, default=11, help="Number of positives + negatives per sample.")
